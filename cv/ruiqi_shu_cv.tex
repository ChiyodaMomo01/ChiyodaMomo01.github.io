...
\begin{enumerate}[label={[\arabic*]},leftmargin=1.8em]
  \pubentry
    ...
    {Accepted by ICML 2026, 2026}
    {\role{First author}}
    {\href{https://arxiv.org/abs/2602.00598}{arXiv}}

  \pubentry
    {NeuralOM: Neural Ocean Model for Subseasonal-to-Seasonal Simulation [AAAI 2026]}
    {Yuan Gao, Hao Wu, Fan Xu, Yanfei Xiang, Ruijian Gou, \textbf{Ruiqi Shu}, Qingsong Wen, Xian Wu, Kun Wang, Xiaomeng Huang}
    {Proceedings of the AAAI Conference on Artificial Intelligence, pp. 14756--14764, 2026}
    {\role{Co-author}}
  ...
  \pubentry
    {An Exterior-Embedding Neural Operator Framework for Preserving Conservation Laws [KDD 2026 Research Track]}
    {Huanshuo Dong, Hong Wang, Hao Wu, Zhiwei Zhuang, Xuanze Yang, \textbf{Ruiqi Shu}, Yuan Gao, Xiaomeng Huang}
    {Accepted by KDD 2026, 2026}
    {\role{Co-author}}
    {\href{https://arxiv.org/abs/2511.16573}{arXiv}}

  \pubentry
    {Ocean-E2E: Hybrid Physics-Based and Data-Driven Global Forecasting of Extreme Marine Heatwaves with End-to-End Neural Assimilation [KDD 2026 AI4Sciences Track]}
  ...
  \pubentry
    {OneForecast: A Universal Framework for Global and Regional Weather Forecasting [ICML 2025]}
    ...
    {International Conference on Machine Learning (ICML), PMLR 267:18658--18697, 2025}
...
\entry{American Geophysical Union 2024 Fall Meeting}{Washington, D.C.}{Presenter, ``A Scale-Aware Framework for Regional to Global Marine Heatwaves Forecast''}{Dec. 2024}
\begin{itemize}
  \item Presented a scale-aware framework for regional-to-global marine heatwave forecasting.
\end{itemize}
...
\vfill
{\footnotesize\color{textgray} Last updated: May 2026.}
