...
\begin{center}
  ...
  \cvsubtitle{清华大学地球系统科学系博士研究生}\\[7pt]
  \small
  中国北京
  \contactsep
...
\section*{研究兴趣}
地球系统科学人工智能；AI for Science；可微地球物理与海洋数值求解器；神经网络--物理混合建模；时空预测；地球物理流体动力学；海洋热浪预测；海洋状态估计。我的研究尤其关注将传统大气与海洋数值求解器转化为可微系统，并与神经网络进行深度耦合。我也在开发 \href{https://neural-pom.vercel.app/}{Neural-POM}，该项目将完整可微海洋数值模式与机器学习相结合。

\section*{教育经历}
\entry{清华大学}{中国北京}{地球系统科学系，大气科学博士研究生}{2024年9月 -- 至今}
\begin{itemize}
  \item 导师：黄小猛教授。
  \item 研究方向：地球系统科学人工智能、可微海洋建模、神经网络--物理融合预测系统。
\end{itemize}

\entry{中国海洋大学}{中国青岛}{崇本学院，海洋科学（物理海洋学）理学学士}{2020年9月 -- 2024年6月}
\begin{itemize}
  \item 接受海洋学、地球物理流体动力学和数学建模方面的本科训练。
\end{itemize}

\section*{研究经历}
\entry{上海科学智能研究院}{中国上海}{研究实习生}{2025年11月 -- 至今}
\begin{itemize}
  \item 围绕复杂地球系统与海洋动力学开展 AI for Science 和神经网络--物理建模研究。
\end{itemize}

\entry{清华大学}{中国北京}{地球系统科学系，研究生研究人员}{2024年9月 -- 至今}
\begin{itemize}
  \item 发展融合物理约束、可微数值求解器和数据驱动预测的机器学习方法。
  \item 研究面向长期模拟、海洋热浪预测和资料同化的海洋与大气混合模型。
\end{itemize}
...
\section*{学术报告}
\entry{American Geophysical Union 2024 Fall Meeting}{Washington, D.C.}{报告人，“A Scale-Aware Framework for Regional to Global Marine Heatwaves Forecast”}{2024年12月}
\begin{itemize}
  \item 报告了一个面向区域到全球海洋热浪预测的尺度感知框架。
\end{itemize}

\section*{荣誉与奖励}
\begin{tabularx}{\textwidth}{@{}p{2.8cm}X@{}}
2022 & \textbf{国家奖学金}，中华人民共和国教育部\\
2023 & \textbf{全国二等奖}，中国数学竞赛\\
...
\vfill
{\footnotesize\color{textgray} 最后更新：2026年5月。}
